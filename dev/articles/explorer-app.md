...
- **Tables.** Pick a table; the app fetches it via
  [`hb_read_table()`](https://cttir.github.io/harbouR/dev/reference/hb_read_table.md),
...
- [`vignette("harbouR")`](https://cttir.github.io/harbouR/dev/articles/harbouR.md) -
  the five-minute end-to-end story.
- [`vignette("column-types")`](https://cttir.github.io/harbouR/dev/articles/column-types.md) -
