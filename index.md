...
and friends work the same whether the base is a file on disk or a server
you administer.
...
host you give it; this is a statement of what the package is built and
documented for, not a technical restriction.
...
- **You can run it yourself.** SeaTable Server can be self-hosted, and
  ...
  via APIs and scripts”, which is precisely what harbouR is for. On your
  own server you decide which API limits apply, or whether any apply at
  all.
