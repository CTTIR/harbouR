...
* **Export.** Download the base as `.dtable`, as an Excel workbook, or as
  zipped CSVs - or just the table you are looking at, as one CSV. The
  `.dtable` keeps everything; the spreadsheet formats flatten whatever a
  cell cannot hold, which the app tells you about.

## Colour

The palette is the package logo's, which is viridis: colourblind-safe and
perceptually uniform. Column types are grouped into families - text,
