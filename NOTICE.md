...
document its API publicly and completely. The authors are grateful for
that work, and for a REST API thorough enough that a client like this one
could be written against it.

If you use SeaTable, please support SeaTable GmbH:
<https://seatable.com/>.
